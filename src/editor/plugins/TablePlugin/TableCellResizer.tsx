...
import { MouseEventHandler, ReactDOM, ReactPortal, useCallback, useEffect, useMemo, useRef, useState } from 'react';
import {
  $computeTableMapSkipCellCheck,
  $getTableNodeFromLexicalNodeOrThrow, $getTableRowIndexFromTableCellNode,
  $isTableCellNode, $isTableRowNode,
  getDOMCellFromTarget, TableCellNode,
  TableDOMCell, TableMapType,
  TableNode,
} from '@lexical/table';
...
export function TableCellResizer({editor}: {editor: LexicalEditor}): JSX.Element {
...
export default function TableCellResizerPlugin(): null | ReactPortal {
  ...
  const TableCellResizer = dynamic(
    async () => (await import("./TableCellResizer")).TableCellResizer,
    {
      ssr: false,
    },
  )
